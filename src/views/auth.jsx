...
export const NewUser = () => {
	return (
		<div id="auth" class="section__content ">
			<div id="signup">
				<input rounded mx='auto' id="alias" placeholder="Enter Your Alias" spellcheck="false" type="text"/>
...
// 	;
 JOY.route.page("auth", function () {
    ...
    document.getElementById(slctr.ALIAS).addEventListener('click', function (e) {
        e.preventDefault();
        $(this).addClass("email");
