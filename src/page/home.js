...
var user = JOY.user;
var introArea = ` 
<header name="header" class="pt100 pb50 bg-grad-stellar" style="background: url({{ bg }}) 50% 50% no-repeat; background-size: cover;">
                    ...
                    <div class="row">
                        <div class="col-md-12 text-center">
                            ...
                            <h4 class=" mt-25 color-gray animated" data-animation="fadeInUp" data-animation-delay="200">
                                This application is in development. Shortcut: To edit content, press <code>C</code> on  your keyboard.
                            </h4>
...
const home = `
<div id="home" name="home" class="page hold">
