export const Account = () => {
    ...
    return (
        <header name="profile" class="section__header" style="background-image: url(%-- backgroundImage --%);">
            <a id="my" class='unit right gap rounded-full' style="background-image: url(%-- avatar --%);">
                    <img id="my" width="64em" class="" src="" />
                </a>
            <h1 class="section__title mt-2">%-- name --%</h1>
...
export function Section({ children, ...opts }) {
    return (
        <section name="main_section" {...opts} class={"main"}>
            <article class="section bg-cover" data-section>
                <Account />
                {children}
            </article >
        </section >
