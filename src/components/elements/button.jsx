...
/**
 * 
 * @param {submit, disabled, isFat, icon, color, label, rounded, onClick} props 
 * @returns JSX.Element
 */
    ...
    return (
        <button
            ...
            className={`${props.isFat ? 'py-4 px-6 ' : 'py-2 px-4 '}${props.icon ? 'flex justify-center items-center ' : ''
                ...
                } text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 ${props.disabled ? ' opacity-70 cursor-not-allowed' : ''
